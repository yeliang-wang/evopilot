...
- Keep README and docs synchronized with CLI behavior, especially ProjectHarnessProfile review/activation, template harness versioning, phase-plan approval, Alpha/Beta/RC/GA standards, LLM profile selection, token usage visibility, logging controls, and GitHub/GitLab DevOps prerequisites.
