...
function bindPath(path: string, input: ToolInput): string {
  return path.replace(/\{(lifecycleId|runId|kind|resourceId|profileId|campaignId|observationId|proposalId|projectDefinitionId|ruleId)\}/g, (_match, name: "lifecycleId" | "runId" | "kind" | "resourceId" | "profileId" | "campaignId" | "observationId" | "proposalId" | "projectDefinitionId" | "ruleId") => {
