export const EVOPILOT_PRODUCT_VERSION_FALLBACK = "1.0.10";
export const EVOPILOT_SERVER_VERSION_FALLBACK = "0.1.0";
export const EVOPILOT_CLI_VERSION_FALLBACK = "1.0.10";
export const EVOPILOT_API_CONTRACT_VERSION = "v1";
export const EVOPILOT_MINIMUM_CLI_VERSION = "1.0.10";
