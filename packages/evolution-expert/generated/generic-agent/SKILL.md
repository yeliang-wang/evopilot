...
- Adapter: `evopilot-evolution-expert-generic-agent@1.0.1`
...
- Version and compatibility: `evopilot-expert version` then `evopilot-expert doctor generic-agent 5.0.1`.
