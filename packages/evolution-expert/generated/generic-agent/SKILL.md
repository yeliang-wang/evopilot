...
- Adapter: `evopilot-evolution-expert-generic-agent@1.1.0`
...
- Version and compatibility: `evopilot-expert version` then `evopilot-expert doctor generic-agent 5.1.0`.
