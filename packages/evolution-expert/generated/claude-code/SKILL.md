---
name: evopilot-evolution-expert-claude-code
description: Generated claude-code adapter for the independently versioned EvoPilot Evolution Expert.
---

# EvoPilot Evolution Expert — claude-code

- Adapter: `evopilot-evolution-expert-claude-code@2.0.0`
