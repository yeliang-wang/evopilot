...
EvoPilot is **v1.0.1 GA** for the open-source product baseline: API/CLI control plane, harness governance, goal loops, release decisions, self-hosting, documentation, and AI Agent operation are ready for external adoption. `v1.0.1` is a publication-hardening patch over the original `v1.0.0` GA baseline.
...
Detailed release evidence and deployment checklists live in [docs/reference/release-package.md](docs/reference/release-package.md), [docs/reference/production-user-e2e.md](docs/reference/production-user-e2e.md), and the public [release notes](docs/releases/1.0.1.md).
