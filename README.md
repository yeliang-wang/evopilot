...
[![Release](https://img.shields.io/badge/GA%20Release-v2.4.1-2ea043)](#release-status)
...
| Self-host now | You want the API, worker, code-upgrader, Postgres, and Dashboard together | `bash -c "$(curl -fsSL https://raw.githubusercontent.com/yeliang-wang/evopilot/v2.4.1/install.sh)"` |
...
The latest published GitHub release is **v2.4.1 GA**, an agent-operable Harness documentation and CLI consistency release over the original `v1.0.0` GA baseline.

v2.4.1 keeps the v2.4.0 source-project Harness evolution workflow unchanged, then adds explicit AI Agent scenario coverage for human-simulated operations, attachment/log/history-driven HarnessTemplate evolution, final report fields, stop rules, and production asset verification for those docs.

Release evidence:

- Latest release notes: [docs/releases/2.4.1.md](docs/releases/2.4.1.md)
