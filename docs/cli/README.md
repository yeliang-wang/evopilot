...
The public npm registry package remains a separate post-publish layer. Use `npm install -g @evopilot/cli@2.1.0` only after `npm run verify:npm-registry -- --version 2.1.0` passes.
