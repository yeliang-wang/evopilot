...
- [EvoPilot v2.2.0 Release Notes](releases/2.2.0.md) - domain Harness execution contract for database and gateway templates, CLI/API contract, and Dashboard compatibility notes.
