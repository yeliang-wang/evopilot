...
- [EvoPilot v2.0.0 Release Notes](releases/2.0.0.md) - domain-first HarnessTemplate model, database/gateway/enterprise management templates, CLI/API contract, and Dashboard compatibility notes.
