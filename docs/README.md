...
- [EvoPilot v2.1.0 Release Notes](releases/2.1.0.md) - domain Harness execution contract for database and gateway templates, CLI/API contract, and Dashboard compatibility notes.
