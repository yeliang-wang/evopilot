...
The tagged installer resolves `create-evopilot` from the release manifest. In v1.1.4, the default package spec is the GitHub Release tarball because public npm registry packages are not published yet.
