...
The tagged installer resolves `create-evopilot` from the release manifest. In v2.3.0, the default package spec is the GitHub Release tarball because public npm registry packages are not published yet.
