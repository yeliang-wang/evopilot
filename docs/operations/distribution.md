...
| --- | --- | --- |
| Install CLI | Operators, CI jobs, and AI agents that already have a server | `npm install -g https://github.com/yeliang-wang/evopilot/releases/download/v1.1.8/evopilot-contracts-1.1.8.tgz https://github.com/yeliang-wang/evopilot/releases/download/v1.1.8/evopilot-client-1.1.8.tgz https://github.com/yeliang-wang/evopilot/releases/download/v1.1.8/evopilot-cli-1.1.8.tgz` |
| Self-host now | New operators bringing up a complete stack | `bash -c "$(curl -fsSL https://raw.githubusercontent.com/yeliang-wang/evopilot/v1.1.8/install.sh)"` |
...
```powershell
iwr https://raw.githubusercontent.com/yeliang-wang/evopilot/v1.1.8/install.ps1 -OutFile install.ps1
...
```bash
curl -fsSL https://raw.githubusercontent.com/yeliang-wang/evopilot/v1.1.8/install.sh \
  | EVOPILOT_INSTALL_PACKAGE_SPEC=create-evopilot@1.1.8 bash -s -- --dir evopilot-stack
cd evopilot-stack
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/yeliang-wang/evopilot/v1.1.8/install.sh | bash -s -- --dir evopilot-stack --start
```
