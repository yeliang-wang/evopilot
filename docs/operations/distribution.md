...
| Self-host now | New operators bringing up a complete stack | `bash -c "$(curl -fsSL https://raw.githubusercontent.com/yeliang-wang/evopilot/v1.1.1/install.sh)"` |
...
```bash
npx create-evopilot@1.1.1 self-host --dir evopilot-stack --start
```
