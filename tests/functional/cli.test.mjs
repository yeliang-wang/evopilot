...
test("EvoPilot CLI exposes distribution metadata without a server", async () => {
  ...
  assert.doesNotMatch(help, /evopilot harness/);
  assert.doesNotMatch(help, /harness profile/);
  assert.doesNotMatch(help, /harness template/);
  assert.doesNotMatch(help, /harness policy/);
