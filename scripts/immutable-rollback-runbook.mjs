...
export function printUsage() {
  return `Usage:
  node scripts/immutable-rollback-runbook.mjs --version 1.1.6 --host root@host --apply --json
  node scripts/immutable-rollback-runbook.mjs --rollback-version 1.1.2 --forward-version 1.1.6 --host root@host --apply --json
