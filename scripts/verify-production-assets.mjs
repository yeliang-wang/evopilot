...
assert.match(aiAgentRunbook, /selectedHarness/);
assert.match(aiAgentRunbook, /EVOPILOT_HARNESS_REGISTRY_CONFIG/);
assert.match(aiAgentRunbook, /Harness Registry/);
assert.match(aiAgentRunbook, /Alpha -> Beta -> RC -> GA/);
assert.match(aiAgentRunbook, /LLM_PROFILE_NOT_READY/);
assert.match(aiAgentRunbook, /PENDING_PLAN_APPROVAL/);
...
assert.match(aiAgentScenarios, /third-party AI Agents/);
assert.match(aiAgentScenarios, /## Scenario Matrix/);
assert.match(aiAgentScenarios, /First-time owned repository to Goal Loop/);
assert.match(aiAgentScenarios, /Catalog readiness check/);
assert.match(aiAgentScenarios, /Harness source evolution/);
assert.match(aiAgentScenarios, /evopilot-harness/);
assert.match(aiAgentScenarios, /plan\.selectedHarness/);
assert.match(aiAgentScenarios, /## Stop Rules/);
assert.match(aiAgentScenarios, /request ids/);
assert.match(aiAgentScenarios, /catalog digest/);
